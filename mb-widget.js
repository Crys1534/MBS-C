...
<div id="caja-comentarios">
  ...
  function calculaT(f){
    ...
    const d=new Date(f);const ho=String(d.getHours()).padStart(2,'0');const mi=String(d.getMinutes()).padStart(2,'0');
    let mE=['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'];
    let dia=d.getDate(),mes=mE[d.getMonth()],anio=d.getFullYear();let tF=`${dia} de ${mes} de ${anio}, ${ho}:${mi}`;
